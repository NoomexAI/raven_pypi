...
class ModelManager:
    ...
    def initiate_base_model(self, model_name: str = None, **kwargs) -> Llama:                              # type: ignore
        ...
        self.set_status("loading_base_model")                                                                #type: ignore
        try:
            ...
            self.set_status("base_model_loaded")                                                             #type: ignore
    ...
    def initiate_embedding_model(self, **kwargs) -> Llama:
        ...
        start_time = time.time()
        self.set_status("loading_embedding_model")                                                           #type: ignore
        try:
            ...
            self.set_status("embedding_model_loaded")                                                        #type: ignore
    ...
    def initiate_sbd_model(self):
        ...
        start_time = time.time()
        self.set_status("loading_sbd_model")                                                                 #type: ignore
        try:
            ...
            self.set_status("sbd_model_loaded")                                                              #type: ignore
    ...
    def ensure_base_model(self, model_name: str | None = None):
        ...
        try:
            self.set_status("downloading_base_model")                                                        #type: ignore
            ...
            self.set_status("base_model_downloaded")                                                         #type: ignore
    ...
    def ensure_embedding_model(self):
        ...
        try:
            self.set_status("downloading_embedding_model")                                                   #type: ignore
            ...
            self.set_status("embedding_model_downloaded")                                                    #type: ignore
    ...
    def ensure_sbd_model(self):
        ...
        self.set_status("downloading_sbd_model")                                                             #type: ignore
        ...
        self.set_status("sbd_model_downloaded")                                                              #type: ignore
